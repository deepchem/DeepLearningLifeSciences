...
conv2d_1 = layers.Conv2D(filters=32, kernel_size=3, activation=tf.nn.relu)(features)
conv2d_2 = layers.Conv2D(filters=64, kernel_size=3, activation=tf.nn.relu)(conv2d_1)
...
keras_model = tf.keras.Model(inputs=features, outputs=dense2)
